        ...
        <div className="space-y-3">
          {jobs.map((job) => (
            <div
              ...
              className="bg-[#0E172A] border border-slate-800 hover:border-sky-500/50 rounded-2xl p-4 space-y-3 cursor-pointer transition shadow-md"
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-[11px] font-mono text-slate-400 mt-0.5">{job.jobNumber}</p>
                </div>
