              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {areaComplaints.length === 0 ? (
                  ...
                  areaComplaints.map((a: any) => (
                    <div key={a.area} className="p-3 bg-[#080D1A] border border-slate-800 rounded-xl flex items-center justify-between text-xs">
                      <div>
                        <p className="font-bold text-white">{a.area}</p>
                        <span className="text-[11px] text-slate-500 font-mono">Top Issue: {a.topIssue}</span>
                      </div>
                      <div className="text-right">
                        <span className="font-mono font-bold text-white">{a.totalTickets} Complaints</span>
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {technicians.length === 0 ? (
                  ...
                  technicians.map((t: any) => (
                    <div key={t.technicianId} className="p-3 bg-[#080D1A] border border-slate-800 rounded-xl flex items-center justify-between text-xs">
                      <div>
                        <p className="font-bold text-white">{t.technicianName}</p>
